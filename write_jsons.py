...
#insertManyJsons(db,'./dados/coord_performace_subjetc.json','subjectperformances') 
insertManyJsons(db,'./dados/desempenhoPercentAlunoXLista.json','studentlistgrades') 